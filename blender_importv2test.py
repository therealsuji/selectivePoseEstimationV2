...
os.system('cls')
path = "D:\Projects\FYP\selectivePoseEstimationV2\outputfile.npy"
...
#size_bone("Point.001", "Point.002", "thigh.R")
#size_bone("Point.002", "Point.003", "shin.R")
#size_bone("Point.004", "Point.005", "thigh.L")
#size_bone("Point.005", "Point.006", "shin.L")
